...
int main ( int argc, char *argv[] )
{
  ...
  if ( argc > 1 )
	...
	{
	  append = 1;
	  std::cout << "Append to existing data in file" << std::endl;
	}
    }
  ...
  std::cout << "R file     : " << fileRL << std::endl;
  std::cout << "Xmgr files : " << fileXmgrR << std::endl;
  std::cout << "           : " << fileXmgrL << std::endl;
  std::cout << " " << std::endl;
  ...
  std::ofstream *xmgrRdata;
  std::ofstream *xmgrLdata;
  std::ofstream *rldata;
  ...
  if ( ! fopen (fileXmgrR, "r") )
    {
      std::cout << fileXmgrR << " does not exist so must initialize" << std::endl;
      init = 1;
    }
  if ( append )
    {
      outdata = new std::ofstream(fileOut, std::ios::app | std::ios::out);
      rldata = new std::ofstream(fileRL, std::ios::app | std::ios::out);
      xmgrRdata = new std::ofstream(fileXmgrR, std::ios::app | std::ios::out);
      xmgrLdata = new std::ofstream(fileXmgrL, std::ios::app | std::ios::out);
    }
  else
    {
      init = 1;

      outdata = new std::ofstream( fileOut, std::ios::out);

      rldata = new std::ofstream( fileRL, std::ios::out);

      xmgrRdata = new std::ofstream( fileXmgrR, std::ios::out);

      xmgrLdata = new std::ofstream( fileXmgrR, std::ios::out);
    }  
  
  if ( init )
    {
      std::cout << "Initializing the xmgr files" << std::endl;
      *xmgrRdata << "@ title \"Resistance\"" << std::endl;
      *xmgrRdata << "@ subtitle \"" << fileXmgrR << "\"" << std::endl;
      *xmgrRdata << "@ yaxis label \"Ohm/m\"" << std::endl;
      *xmgrRdata  << "@ xaxis label \"Frequency (Hz)\"" << std::endl;
      *xmgrRdata << "@ legend string 0 \"Signal1,Signal1\"" << std::endl;
      *xmgrRdata << "@ legend string 1 \"Signal1,Signal2\"" << std::endl;
      *xmgrRdata << "@ legend string 2 \"Signal2,Signal1\"" << std::endl;
      *xmgrRdata << "@ legend string 3 \"Signal2,Signal2\"" << std::endl;
      *xmgrRdata << "@ type nxy" << std::endl;
      std::cout  << "@ title \"Resistance\"" << std::endl;
      std::cout  << "@ subtitle \"" << fileXmgrR << "\"" <<  std::endl;
      std::cout  << "@ yaxis label \"nH/m\"" << std::endl;
      std::cout  << "@ xaxis label \"Frequency (Hz)\"" << std::endl;
      std::cout  << "@ legend string 0 \"Signal1,Signal1\"" << std::endl;
      std::cout  << "@ legend string 1 \"Signal1,Signal2\"" << std::endl;
      std::cout  << "@ legend string 2 \"Signal2,Signal1\"" << std::endl;
      std::cout  << "@ legend string 3 \"Signal2,Signal2\"" << std::endl;
      std::cout  << "@ type nxy" << std::endl;

      *xmgrLdata << "@ title \"Inductance\"" << std::endl;
      *xmgrLdata << "@ subtitle \"" << fileXmgrL << "\"" << std::endl;
      *xmgrLdata << "@ yaxis label \"Ohm/m\"" << std::endl;
      *xmgrLdata << "@ legend string 0 \"Signal1,Signal1\"" << std::endl;
      *xmgrLdata << "@ legend string 1 \"Signal1,Signal2\"" << std::endl;
      *xmgrLdata << "@ legend string 2 \"Signal2,Signal1\"" << std::endl;
      *xmgrLdata << "@ legend string 3 \"Signal2,Signal2\"" << std::endl;
      *xmgrLdata << "@ type nxy" << std::endl;
      std::cout  << "@ subtitle \"" << fileXmgrL << "\"" << std::endl;
      std::cout  << "@ yaxis label \"nH/m\"" << std::endl;
      std::cout  << "@ legend string 0 \"Signal1,Signal1\"" << std::endl;
      std::cout  << "@ legend string 1 \"Signal1,Signal2\"" << std::endl;
      std::cout  << "@ legend string 2 \"Signal2,Signal1\"" << std::endl;
  ...
  //  time(&tme2);
  //  std::cout << "time 1: " << tme2 - tme1 << std::endl;
  //  tme1 = tme2;
  ...
  //  time(&tme2);
  //  std::cout << "time 2: " << tme2 - tme1 << std::endl;
  //  tme1 = tme2;
  ...
  //  time(&tme2);
  //  std::cout << "time 3: " << tme2 - tme1 << std::endl;
  //  tme1 = tme2;
  ...
  for(i2 = 1; i2 < Nc; i2 ++) {
	...
	Rhsw[2*Nc*Nw+i] = (-1.0)*Ic*Iq_sq[i]*oms*tempc/power(2.0,double(J)/2.0);
      ...
      //  time(&tme2);
      //  std::cout << "time 4: " << tme2 - tme1 << std::endl;
      //  tme1 = tme2;
  ...
  //	   << std::endl;
	...
	Rhsw = xc;
      ...
      //      std::cout << " System of linear equations for N = " 
      //	   << NN                
      //	   << " solved !!! " 
      //	   << std::endl;
	...
	Ind[i] = 0.0;
      ...
      //  time(&tme2);
      //  std::cout << "time 5: " << tme2 - tme1 << std::endl;
      //  tme1 = tme2;
  ...
  //  time(&tme2);
  //  std::cout << "time 6: " << tme2 - tme1 << std::endl;
  //  tme1 = tme2;
  ...
  time(&end_time);
  //  std::cout << "time 7: " << end_time - tme1 << std::endl;
  //  tme1 = tme2;
  ...
  std::cout << "User CPU time: " << run_times.tms_utime/CLOCKS_PER_SEC << std::endl;
  std::cout << " Sys CPU time: " << run_times.tms_stime/CLOCKS_PER_SEC << std::endl;
#endif
  ...
  *outdata << "--------------------------------------------------------" 
	   << std::endl;
  *outdata << "Resistance/Inductance Values" << std::endl;
  ...
  *outdata << Nc-1 << ""
	   << "X" << ""
	   << Nc-1 << ""
	   << " Resistance Matrix (Ohm/m):" << std::endl;
  *outdata <<std::endl;
  ...
  *outdata << Nc-1 << ""
	   << "X" << ""
	   << Nc-1 << ""
	   << " Inductance Matrix (H/m):" << std::endl;
  *outdata <<std::endl;
  ...
  *outdata << std::endl;
#ifdef HAVE_SYS_TIMES_H
  *outdata << "User CPU time: " << run_times.tms_utime/CLOCKS_PER_SEC << std::endl;
  *outdata << " Sys CPU time: " << run_times.tms_stime/CLOCKS_PER_SEC << std::endl;
#endif
